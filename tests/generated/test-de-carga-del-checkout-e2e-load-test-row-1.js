 ...
 * Scenario: Test de carga del checkout E2E [Load Test — Row 1]
 * Examples: Load Test
 * Parameters: {"vus":"10","duration":"2m","quantity":"1","threshold_p95":"5000","success_rate":"60","failure_rate":"15"}
 * 
...
export const options = {
    "scenarios": {
        "test_de_carga_del_checkout_e2e_load_test": {
...
// ─────────────────────────────────────────────────────────────
// DEFAULT — Test de carga del checkout E2E [Load Test — Row 1]
// ─────────────────────────────────────────────────────────────
export default function (data) {
    ...
    // Threshold assertion: checkout success rate > 60%
...
export function teardown(data) {
    console.log('🏁 Test BDD completado: Test de carga del checkout E2E [Load Test — Row 1]');
}
...
export function handleSummary(data) {
    ...
    return {
        [`reports/bdd-test-de-carga-del-checkout-e2e-load-test-row-1_${ts}.html`]: htmlReport(data),
        [`reports/bdd-test-de-carga-del-checkout-e2e-load-test-row-1_${ts}.json`]: JSON.stringify(data, null, 2),
